...
public interface IPairingService { Task<PairingOutcome> VerifyPinAsync(Guid userId, string agentId, string pin); Task<bool> UpdateAgentPinAsync(string agentId, string pin); }
